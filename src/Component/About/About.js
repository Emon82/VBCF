            ...
            <section>
                <div className="about-Us">
                    <div className="container">
                        <h2 style={{ padding: "10px", textAlign: 'center' }}>About</h2>
                        <div className="row">
                            <div className="col-9">
                                <p>Western Region Bengali School (WRBS) is an ethnic language school targeting the second generation Australian Bangladeshis living in the north and western suburbs of Melbourne. However, it is open to all Australian Bangladeshi living in Victoria. WRBS formed in 2006, in Hoppers Crossing, Victoria with goals of promoting Bangla literacy and numeracy and passing on the rich Bangladeshi cultural heritage to our next generation Australian-Bangladeshi. The school has come a long way since its inception as an entity that currently has 152 enrolled students.
                                    To meet the increasing needs of our rapidly growing Bangladeshi community here in Victoria, over the years WRBS council have taken different initiatives to support the community and formed following additional entities •Western Region Islamic Class for Children (in operation);
                                    •Western Region Islamic Class for Adults (in operation);<br />
                                    •Victorian Bangla Mobile Library (in operation);<br />
                                    •Victorian Bangladeshi Sports Club (in operation); and<br />
                                    •Victorian Bangladeshi Women’s Advancement (Proposed).</p>
                                <p>As the activities and tasks have evidenced a sustained growth in running various wings, it is now becoming increasingly difficult for WRBS to cope up with the community needs and discharge its responsibilities to coordinate all other wings as listed above.
